/*
 * SIInDZ.c - This file stores all of the differential functions that are used
...
// These variables are initialized and assigned their values in the zombieSIInDZ.cpp
// program, but we still need them to be within the scope of the SIInDZ.c file.
