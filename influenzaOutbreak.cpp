            ...
            if (argv[i][0] == '-') {
                ...
                switch (c) {
                    case 's':   // -s: Initial susceptible value. Value must be a
                        ...
                        CurrentSusceptible = strtol(str, &endptr, 0); // Store the provided value.
                        ...
                        if (str == endptr) {
                            fprintf(stderr, "No digits provided for the initial susceptible value.\n");
                            exit(EXIT_FAILURE);
                        }
                        ...
                        if (CurrentSusceptible < 0) {
                            fprintf(stderr, "The provided value of %ld is invalid\n",
                                    CurrentSusceptible);
                            exit(EXIT_FAILURE);
                        }

                        // If everything looks good however, we can store the
                        // provided value for the initial susceptible amount.
                        break;
                    case 'i':   // -i: Initial infected value. Value must be a whole
                                // positive integer.
                        CurrentInfected = strtol(str, &endptr, 0); // Store the provided value.
                        ...
                        // there was never a numeric section to str!
                        if (str == endptr) {
                            fprintf(stderr, "No digits provided for the initial infected value.\n");
                            exit(EXIT_FAILURE);
                        }
                    ...
                    case 'a':   // -a: Rate of infection (from susceptible to
                        ...
                        // there was never a numeric section to str
                        if (str == endptr) {
                            fprintf(stderr, "No digits provided for the infection rate value.\n");
                            exit(EXIT_FAILURE);
                        }
                        ...
                        // not less than 0.
                        if (InfectionRate < 0) {
                            fprintf(stderr, "The provided value of %f is invalid.\n",
                                    InfectionRate);
                            exit(EXIT_FAILURE);
                        }

                        // If everything looks good however, we can store the
                        // provided value for the infection rate.
                        break;
                    case 'r':   // -r: Rate of recovery (from infected to recovered).
                                // Must be a non-negative value.
                        RecoveryRate = strtod(str, &endptr);
